...
const FabConComponent = (props) =>{
    ...
    const add = async() => {
        setVolume(volume+1);
        await AsyncStorage.setItem('fabconvolume', JSON.stringify(volume+1));
        await AsyncStorage.setItem('fabconcost', JSON.stringify(volume * props.cost + props.cost));
    }
...
export default FabConComponent;